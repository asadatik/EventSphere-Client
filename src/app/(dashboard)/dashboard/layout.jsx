    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <div className='h-[90px] '>
                <div className="fixed z-50 w-full bg-[#1b85db] shadow-lg  ">  {/* Set a height for the navbar */}
                    <div className="relative w-full]">
                        ...
                        <BsLayoutSidebar
                            ...
                            size={23}
                            className="absolute right-5 top-[40%] text-white md:hidden cursor-pointer"
                        />
                    </div>
                </div>
            </div>
            ...
            <div className='absolute z-50'>
                <div className='flex flex-col gap-2 fixed  right-0 bottom-[30%] '>
                    <Link href={'/messenger'} className="group relative w-[70px] h-[70px] rounded-md overflow-hidden cursor-pointer bg-gradient-to-r from-[#3b99f1] via-[#4FB5FF] to-[#4FB5FF] p-2 text-white shadow">
                    ...
                    <Link href={'/events'} className="group relative w-[70px] h-[70px] rounded-md overflow-hidden cursor-pointer bg-gradient-to-r from-[#3b99f1] via-[#4FB5FF] to-[#4FB5FF] p-2 text-white shadow">
                        <span className="absolute left-[-10%] top-[50%] z-10 h-[20px] w-[20px] rounded-full bg-gradient-to-r from-[#0064c2] via-[#49aef7] to-[#c7e0f1] duration-300 group-hover:top-[-10%] group-hover:blur-sm"></span>
                        <span className="absolute right-[-5%] top-[10%] z-10 h-[20px] w-[30px] rounded-full bg-gradient-to-tr from-[#0064c2] via-[#4FB5FF] to-[#4FB5FF] duration-300 group-hover:top-[80%] group-hover:blur-sm"></span>
                        <div className="relative z-20 space-y-6 flex flex-col items-center justify-center ">
