...
const Cards = () => {
  ...
  const { data: myPosts } = useQuery({
    ...
    queryFn: () =>
      fetch(`https://eventsphare-server-psun.onrender.com/getUserPosts/${lastPathSegment}`).then((res) =>
        res.json()
      ),
  });
  ...
  const handleFollow = async () => {
    ...
    try {
      const result = await axios.put("https://eventsphare-server-psun.onrender.com/userAddedFollower", addedFollower);
      console.log(result);
